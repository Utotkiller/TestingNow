...
export const sampleLostFoundReports: LostFoundReport[] = [
  {
    ...
    date: '2026-06-22',
    photoSrc: assetPath('/cats/mochi-orange-tabby.png'),
  ...
  },
  {
    ...
    date: '2026-06-21',
    photoSrc: assetPath('/cats/tuxedo-bus-stop.png'),
    contactName: 'Report owner',
    contactMethod: 'Protected contact request',
    status: 'active',
    urgency: 'normal',
  ...
  },
  {
    ...
    date: '2026-06-20',
    photoSrc: assetPath('/cats/shadow-black-cat.png'),
    contactName: 'Report owner',
    contactMethod: 'Protected contact request',
    status: 'active',
    urgency: 'normal',
  ...
  },
  {
    ...
    date: '2026-06-19',
    photoSrc: assetPath('/cats/calico-rain.png'),
    contactName: 'Report owner',
    contactMethod: 'Protected contact request',
    status: 'active',
    urgency: 'normal',
  ...
  },
  {
    ...
    date: '2026-06-18',
    photoSrc: assetPath('/cats/biscuit-tabby-kitten.png'),
    contactName: 'Report owner',
    contactMethod: 'Protected contact request',
    status: 'resolved',
    urgency: 'normal',
