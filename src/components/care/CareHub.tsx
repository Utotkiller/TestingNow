...
const fallbackImage = assetPath('/cats/mochi-orange-tabby.png')
              ...
              <div className="border-b border-wm-line bg-wm-ink px-4 py-4 text-white">
                ...
                <label className="mt-2 block">
                  ...
                  <select
                    ...
                    className="w-full appearance-none rounded-xl border border-white/20 bg-white px-3 py-2.5 text-sm font-black text-wm-ink outline-none focus:ring-4 focus:ring-white/15"
                  >
    ...
    <Card>
      ...
      <div className="grid gap-4 p-4 sm:p-5 lg:grid-cols-[1.1fr_0.9fr]">
        ...
        <form onSubmit={add} className="rounded-2xl bg-wm-ink p-4 text-white">
          ...
          <div className="mt-3 grid gap-3">
            <label className="grid gap-1.5 text-xs font-black text-white/65">Time<select value={time} onChange={(event) => setTime(event.target.value)} className="min-h-11 rounded-xl border border-white/14 bg-white px-3 text-sm font-bold text-wm-ink"><option className="text-wm-ink">Morning</option><option className="text-wm-ink">Afternoon</option><option className="text-wm-ink">Evening</option></select></label>
